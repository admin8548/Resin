...
func NewServerWithAddress(
	...
	if cp != nil {
		...
		authed.Handle("GET /api/v1/nodes/{hash}/dest-bans", HandleListNodeDestBans(cp))
		authed.Handle("POST /api/v1/nodes/{hash}/dest-bans", HandleCreateNodeDestBan(cp))
		authed.Handle("DELETE /api/v1/nodes/{hash}/dest-bans", HandleDeleteNodeDestBan(cp))
